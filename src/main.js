...
export const globalTranslations = {
  en: {
    ...
    heroSubtitle: 'Premium real estate platform in Dubai and UAE',
    propertiesTitle: 'Explore Our Properties',
    propertiesSubtitle: 'Discover a wide range of premium properties',
    viewFeaturedProperties: 'View Featured Properties',
    learnMore: 'Learn More',
    latestNews: 'Latest News',
    newsSubtitle: 'Stay updated with the latest trends and insights in the real estate market',
    ...
    specialistConnect: 'Connect with a Specialist',
    expertAssistance: 'Expert Real Estate Assistance',
    expertAssistanceDesc: 'Access our dedicated team of over 400+ expert agents ready to assist you. Our team of experienced real estate specialists is available to provide personalized assistance for all your property needs, from inquiries to closing deals.',
    listProperty: 'List Your Property',
    marketingSolutions: 'Professional Marketing Solutions',
    marketingSolutionsDesc: 'Achieve optimal value by listing your property with our expert marketing strategies. Maximize your property\'s exposure with our comprehensive marketing approach, including professional photography, virtual tours, and targeted advertising campaigns.',
    downloadReport: 'Download Report',
    marketInsights: 'Market Insights for Informed Decisions',
    marketInsightsDesc: 'Download the latest Comprehensive Dubai Real Estate Market Report Q1 2025. Gain valuable insights into market trends, property values, and investment opportunities with our detailed quarterly report covering the entire Dubai real estate landscape.',
    exploreProjects: 'Explore Dubai Projects',
    discoverDream: 'Discover Your Dream Property',
    discoverDreamDesc: 'Browse and find your ideal property from our extensive portfolio of Dubai projects. Discover a wide range of residential and commercial properties across Dubai\'s most sought-after locations, with detailed information and specifications for each project.',
    newsTitle1: 'Lyvia By Palace Grand Launch on October 13, 2025',
    newsTitle2: 'SOLAYA: New Luxury Residence at Dubai\'s La Mer Beach, Combining Frontline Sea View and Urban Vibrancy',
    newsTitle3: 'Report Analysis: UAE Real Estate Becomes Core Driver of Economic Growth',
    newsDesc1: 'Lyvia By Palace will launch at 5:00 PM on October 13, 2025, with expected delivery in 2029. Located at a prime location with imminent completion of Cloud Tower, upcoming metro line opening, prestigious schools, shopping malls and commercial buildings. Whether for investment or personal residence, Lyvia By Palace is an excellent choice.',
    newsDesc2: 'In Dubai\'s high-end real estate market, frontline sea view luxury properties with prime locations have always been rare. Now, La Mer Beach on the Jumeirah Gold Coast welcomes a new luxury residential project - SOLAYA.',
    newsDesc3: 'Amid global economic challenges, the United Arab Emirates continues to strengthen its position as a "safe investment haven" in the Middle East, thanks to its unique geographical advantages and stable investment environment. The latest report indicates that the real estate industry has become a major driver of UAE economic growth.',
    ...
    footerBuyProperty: 'Buy Property',
    footerSellProperty: 'Sell Property',
    footerRentProperty: 'Rent Property',
    footerPropertyManagement: 'Property Management',
    ...
    contactSubtitle: 'Have questions? Reach out to our team for assistance.',
    companyIntroTitle: 'The new way to find your\ndevelopment opportunities',
    companyIntroDesc: 'Discover your next development project with more than 10+opportunities and professional services listed.',
    companyStatAgents: 'Agents',
    companyStatListings: 'Listings',
    companyStatCountries: 'Countries',
    ...
    footerAddress: 'Dubai Marina, Dubai',
    propertyMontiva: 'Montiva by Vida',
    propertyPalace: 'The Palace Villas Ostra',
    propertyRosehill: 'Rosehill',
    propertyGolf: 'Golf Hillside',
    propertyTypeApartment: 'Apartment',
    propertyTypeVilla: 'Villa',
    propertyStatusSale: 'Residential for Sale',
    
    // 弹窗内容
    lyviaModalContent: `
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">Project Launch Information</h4>
        <p>Lyvia By Palace will be launched on October 13, 2025 at 5:00 PM, with expected delivery in 2029. This project stands at the threshold of significant growth opportunities, coinciding with the completion of Creek Tower, the opening of the Blue Line Metro, the launch of prestigious schools, the start of shopping mall construction, and the arrival of major office complexes and enterprises. These converging infrastructure developments mark the perfect time for property value appreciation. Whether for investment or owner-occupation, Lyvia By Palace is the ideal choice.</p>
      </div>
      ...
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">Creek Harbour's "Zero-Commute" Family Luxury Residence</h4>
        <p>Creek Harbour's central city government positioning and supporting business district with towers, malls, and office buildings drive high property price growth and inflation-resistant attributes. Combined with the high liquidity and high rental yield attributes of school district housing, plus the five-star Palace Hotel brand enhancement, rental and resale prices are 20% higher than ordinary buildings, making it the best residential investment project of the year.</p>
      </div>
      
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">Strong Developer Support: Emaar</h4>
        <p>Emaar Properties PJSC, founded in 1997, is the largest land and real estate developer in the Middle East. As a world-leading real estate company, Emaar is a real estate giant and leader throughout the UAE, listed on the Dubai Financial Market and the Dow Jones Arab Titans Index.</p>
      </div>
      
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">Prime Location Value, Dubai Creek Harbour Core Area</h4>
        <p>Dubai Creek Harbour is located along The Creek, adjacent to Ras Al Khor, Dubai's largest wildlife reserve - the Flamingo Nature Reserve. It is a comprehensive area developed by Emaar, Dubai's largest developer, integrating residential, shopping, entertainment, and commercial office spaces along Dubai Creek.</p>
      </div>
    `,
    
    solayaModalContent: `
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">Prime Beachfront Location, Exclusive 234 Luxury Residences</h4>
        <p>SOLAYA is strategically located along Dubai's prestigious Jumeirah Golden Coastline, offering an irreplaceable beachfront position. From every window, residents are treated to unobstructed panoramic views of the majestic Arabian Gulf and the iconic Dubai skyline, transforming the dream of living by the sea into reality.</p>
      </div>
      ...
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">Multidimensional Advantages, Defining New Luxury Standards</h4>
        <p>SOLAYA has become one of Dubai's most talked-about beachfront luxury projects due to its outstanding advantages in developer reputation, location, transportation, amenities, and market potential, comprehensively meeting both residential and investment needs.</p>
        
        <div style="margin-top: 10px;">
          <p><strong>Advantage 1: Strong Developer Backing, Significant Investment Potential</strong></p>
          <p>SOLAYA is developed by Dubai Holding, one of the largest real estate developers in the Emirate of Dubai.</p>
        </div>
        
        <div style="margin-top: 10px;">
          <p><strong>Advantage 2: World-Class Beach Destination with Vibrant Lifestyle</strong></p>
          <p>The project is located in La Mer beach, a world-class coastal destination in Jumeirah 1, developed by the renowned Meraas.</p>
        </div>
      </div>
    `,
    ...
    reportModalContent: `
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">UAE Real Estate: Core Driver of Economic Growth</h4>
        <p>Amid global economic challenges, the UAE continues to strengthen its position as a "safe haven for investment" in the Middle East, thanks to its unique geographical advantages and stable investment environment. Recent international research reports indicate that the real estate industry has become a key engine driving economic growth in the UAE.</p>
      </div>
      
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">01 Off-Plan Market Leads Growth in Both Major Cities</h4>
        <p>According to the latest statistics from JLL, the off-plan sales markets in Dubai and Abu Dhabi experienced explosive growth in the first half of 2025, with transaction data reaching new highs.</p>
        <p>Dubai: Off-plan sales in Q2 reached AED 153.7 billion, a significant 44.5% increase year-over-year, setting a new historical record.</p>
        <p>Abu Dhabi: Average off-plan prices rose by 12.1% during the same period, with high-end and mid-to-high-end residential projects continuing to gain market favor.</p>
      </div>
      
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">02 Rental Market Remains Stable with Strong Renewal Demand</h4>
        <p>In addition to the booming off-plan market, the UAE's rental market also showed steady performance with continuous demand growth.</p>
      </div>
    `,
    
    defaultModalContent: "Stay tuned for more updates and detailed information about this exciting development. Our team of real estate experts is available to provide personalized consultations and answer any questions you may have about the current market trends and investment opportunities."
  },
  zh: {
    heroTitle: '寻找您的梦想',
    ...
    marketingSolutionsDesc: '通过我们专业的营销策略发布您的房产，实现最佳价值。我们的综合营销方法包括专业摄影、虚拟看房和精准广告投放，最大化您房产的曝光率。',
    downloadReport: '下载报告',
    marketInsights: '市场洞察助力明智决策',
    marketInsightsDesc: '下载最新的2025年第一季度迪拜房地产市场综合报告。通过我们详细的季度报告，获取关于市场趋势、房产价值和投资机会的宝贵洞察，全面覆盖迪拜房地产市场。',
    exploreProjects: '探索迪拜项目',
    discoverDream: '发现您的梦想房产',
    discoverDreamDesc: '从我们丰富的迪拜项目组合中浏览并找到您理想的房产。探索迪拜最受欢迎地区的各类住宅和商业房产，每个项目都有详细信息和规格。',
    ...
    footerContact: '联系我们',
    footerServices: '服务',
    footerBuyProperty: '购买房产',
    footerSellProperty: '出售房产',
    footerRentProperty: '租赁房产',
    footerPropertyManagement: '物业管理',
    footerPrivacyPolicy: '隐私政策',
    footerTermsOfService: '服务条款',
    footerCookiePolicy: 'Cookie政策',
    ...
    formMessagePlaceholder: '您的留言',
    formSubmitButton: '发送留言',
    formSuccessMessage: '留言发送成功！',
    footerEmail: 'Info@hawsonhouse.com',
    footerPhone: '+971 506956105',
    ...
    lyviaModalContent: `
      ...
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">强大开发商支持：Emaar</h4>
        <p>Emaar Properties PJSC成立于1997年，是中东地区最大的土地和房地产开发商。作为世界领先的房地产公司，Emaar是整个阿联酋的房地产巨头和领导者，在迪拜金融市场和道琼斯阿拉伯泰坦指数上市。</p>
      </div>
      
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">核心区位价值，迪拜Creek Harbour核心区域</h4>
        <p>迪拜Creek Harbour位于The Creek沿岸，毗邻迪拜最大的野生动物保护区——火烈鸟自然保护区Ras Al Khor。它是由迪拜最大的开发商Emaar开发的综合区域，沿着迪拜河融合了住宅、购物、娱乐和商业办公空间。</p>
      </div>
    `,
    ...
    reportModalContent: `
      <div style="margin-bottom: 25px;">
        <h4 style="color: #333; margin-bottom: 15px; font-size: 1.2rem;">全球经济挑战下的中东投资安全港</h4>
        <p>在全球经济面临多重挑战的当下，阿联酋凭借其独特的区位优势与稳定的投资环境，持续巩固着中东地区 "投资安全港" 的地位。最新发布的国际研究报告指出，房地产行业已成为拉动阿联酋经济增长的关键引擎，且在 2025 年将延续向上发展的良好态势。</p>
      </div>
  ...
  ar: {
    heroTitle: 'Find Your Dream',
    heroSubtitle: 'منصة عقارية متميزة في دبي والإمارات العربية المتحدة',
    propertiesTitle: 'استكشف عقاراتنا',
    propertiesSubtitle: 'اكتشف مجموعة واسعة من العقارات المتميزة',
    viewFeaturedProperties: 'عرض العقارات المميزة',
    learnMore: 'اعرف المزيد',
    latestNews: 'آخر الأخبار',
    newsSubtitle: 'تابع آخر الاتجاهات والرهانات في سوق العقارات',
    viewAllNews: 'عرض جميع الأخبار',
    missionTitle: 'مهمتنا هي إعادة تعريف العقارات لصالح العميل.',
    missionSubtitle: 'لوريم إبسوم دولار سيت أميت',
    specialistConnect: 'اتصل بالاخصائي',
    expertAssistance: 'مساعدة عقارية متخصصة',
    expertAssistanceDesc: 'الوصول إلى فريقنا المخصص المكون من أكثر من 400 وكيلًا ماهرًا جاهزين للمساعدة معك. فريقنا من متخصصي العقارات ذوي الخبرة متاحون لتقديم مساعدة شخصية لجميع احتياجات العقارات الخاصة بك، من الاستفسارات حتى إغلاق الصفقات.',
    listProperty: 'قم بتسجيل عقارك',
    marketingSolutions: 'حلول التسويق المحترفة',
    marketingSolutionsDesc: 'حقق القيمة المثلى عن طريق تسجيل عقارك مع استراتيجيات التسويق المتخصصة لدينا. تعظيم تعرض عقارك مع نهج التسويق الشامل لدينا، بما في ذلك التصوير المحترف، جولات افتراضية، وحملات إعلانات تستهدف.',
    downloadReport: 'تنزيل التقرير',
    marketInsights: 'رؤى السوق لاتخاذ قرارات مستنيرة',
    marketInsightsDesc: 'تنزيل أحدث تقرير سوق العقارات الشامل لدبي الربع الأول 2025. احصل على رؤى قيمة حول اتجاهات السوق، وقيم العقارات، وفرص الاستثمار مع تقريرنا الدوري التفصيلي الذي يغطي مشهد العقارات الكامل في دبي.',
    exploreProjects: 'استكشف مشاريع دبي',
    discoverDream: 'اكتشف عقار أحلامك',
    discoverDreamDesc: 'تصفح وابحث عن عقارك المثالي من مجموعتنا الواسعة من مشاريع دبي. اكتشف مجموعة واسعة من العقارات السكنية والتجارية عبر أقسام دبي الأكثر طلبًا، مع معلومات مفصلة وتواصيف لكل مشروع.',
    newsTitle1: 'إطلاق Lyvia By Palace الكبير في 13 أكتوبر 2025',
    newsTitle2: 'SOLAYA: سكن فاخر جديد على شاطئ لامير في دبي، يجمع بين منظره ساحليًا وصحة حضرية زاخرة',
    newsTitle3: 'تقرير تحليلي: العقارات في الإمارات العربية المتحدة تصبح محركًا أساسيًا لنمو الاقتصاد',
    newsDesc1: 'ستطلق Lyvia By Palace في الساعة 5:00 مساءً يوم 13 أكتوبر 2025، مع التسليم المتوقع في عام 2029. تقع في موقع ممتاز مع انتهاء بناء برج الكلاود وشحن خط المترو القادم ومدارس ملتهبة ومجمعات تسوق ومباني تجارية. سواء للاستثمار أو السكن الشخصي، فإن Lyvia By Palace اختيار ممتاز.',
    newsDesc2: 'في سوق العقارات العليا في دبي، كانت عقارات الفاخرة التي تواجه البحر مباشرة وتقع في مواقع بارزة نادرة دائمًا. الآن، ترحب شاطئ لامير على ساحل جوميرا الذهبي بمشروع سكني فاخر جديد - SOLAYA.',
    newsDesc3: 'وسط التحديات الاقتصادية العالمية، تستمر الإمارات العربية المتحدة في تعزيز مكانتها كـ\"مكان آمن للاستثمار\" في الشرق الأوسط بفضل مزاياها الجغرافية الفريدة وبيئتها الاستثمارية المستقرة. تشير التقرير الأخير إلى أن صناعة العقارات أصبحت محركًا رئيسيًا يقود نمو اقتصاد الإمارات العربية المتحدة.',
    ...
    footerTagline: 'منصة عقارية متميزة في دبي والإمارات العربية المتحدة',
    footerServices: 'الخدمات',
    footerBuyProperty: 'شراء عقار',
    footerSellProperty: 'بيع عقار',
    footerRentProperty: 'إيجار عقار',
    ...
    contactSubtitle: 'هل لديك أسئلة؟ تواصل مع فريقنا للحصول على المساعدة.',
    companyIntroTitle: 'الطريقة الجديدة للعثور على فرص التطوير الخاصة بك',
    companyIntroDesc: 'اكتشف مشروعك التطويري التالي مع أكثر من 10 فرص وخدمات احترافية مدرجة.',
    companyStatAgents: 'وكلاء',
    companyStatListings: 'القوائم',
    companyStatCountries: 'دول',
    formNamePlaceholder: 'اسمك',
    formEmailPlaceholder: 'بريدك الإلكتروني',
    formMessagePlaceholder: 'رسالتك',
    formSubmitButton: 'إرسال الرسالة',
    formSuccessMessage: 'تم إرسال الرسالة بنجاح!',
    footerEmail: 'Info@hawsonhouse.com',
    footerPhone: '+971 506956105',
    footerAddress: 'دبي مارينا، دبي',
    propertyMontiva: 'مونتيفا بو فيدا',
    propertyPalace: 'فيلات القصر أوسترا',
    propertyRosehill: 'روزهيل',
    propertyGolf: 'جبل الجولف',
    propertyTypeApartment: 'شقة',
    propertyTypeVilla: 'فيلا',
    propertyStatusSale: 'سكن للبيع'
  }
};
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    /* 悬停时文本变白色 */
    .company-stat:hover .stat-number,
    .company-stat:hover .stat-label {
      color: white;
    }
    ...
    /* 增强英雄区域 */
      ...
      .floating-button {
        ...
        opacity: 0.7; /* 设置透明度为70%，使按钮清晰可见同时保持美观 */
      ...
      function updatePageLanguage(lang) {
        ...
        if (translationsObj) {
          ...
          metaItems.forEach(item => {
            ...
            if (translateSpan) {
              const key = translateSpan.getAttribute('data-translate');
              if (key === 'property.developer') {
                translateSpan.textContent = translationsObj.property.developer + ':';
              } else if (key === 'property.area') {
                translateSpan.textContent = translationsObj.property.area + ':';
              } else if (key === 'property.handoverDate') {
                translateSpan.textContent = translationsObj.property.handoverDate + ':';
              }
            }
            // 保留原有的替换逻辑，以防有未添加data-translate属性的元素
          ...
          propertyStatuses.forEach(statusElement => {
            ...
            // 从中文翻译到英文
            else if (statusText === '住宅出售' && lang === 'en') {
              statusElement.textContent = 'Residential for Sale';
            }
            // 从阿拉伯语翻译到英文
            else if (lang === 'en' && statusElement.textContent.includes('للبيع')) {
              statusElement.textContent = 'Residential for Sale';
            }
          });
          ...
          if (footer) {
            ...
            socialLinks.forEach(link => {
              ...
              // 添加点击事件处理，阻止默认行为和事件冒泡
              // 确保事件监听器正确绑定，防止触发其他点击事件
  ...
  heroSection.innerHTML = `
    ...
    <div id="hero-content" class="hero-content" style="opacity: 0; transition: opacity 0.8s ease-in-out;">
      <h1 data-translate="heroTitle">Find Your Dream</h1>
      <p data-translate="heroSubtitle">Premium real estate platform in Dubai and UAE</p>
    </div>
  `;
  ...
  // 显示备用背景图片的函数
    ...
    // 设置5秒超时
    loadTimeout = setTimeout(handleVideoLoadTimeout, 5000);
    ...
    <div class="section-header">
      <div class="header-content-wrapper">
        <div class="header-text">
          <h2 data-translate="propertiesTitle">Explore Our Properties</h2>
          <p data-translate="propertiesSubtitle">Discover a wide range of premium properties</p>
        </div>
    ...
    <div class="properties-grid">
      ...
      <div class="property-card">
        ...
        <div class="property-details">
          <h3 data-translate="propertyMontiva">Montiva by Vida</h3>
          <p class="property-type" data-translate="propertyTypeApartment">Apartment</p>
          <div class="property-price">1,910,000 AED</div>
          <p class="property-status" data-translate="propertyStatusSale">Residential for Sale</p>
          <div class="property-meta">
            <div class="meta-item">
              ...
              <span data-translate="property.developer">Developer:</span> Emaar
            </div>
            <div class="meta-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <span data-translate="property.area">Area:</span> Dubai Creek Harbour, Dubai
            </div>
            <!-- Listed On removed -->
            <div class="meta-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <span data-translate="property.handoverDate">Handover Date:</span> 09-2029
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="property-card">
        ...
        <div class="property-details">
          <h3 data-translate="propertyPalace">The Palace Villas Ostra</h3>
          <p class="property-type" data-translate="propertyTypeVilla">Villa</p>
          ...
          <div class="property-meta">
            ...
            <div class="meta-item">
              ...
              <span data-translate="property.area">Area:</span> The Oasis by Emaar, Dubai
            </div>
            <!-- Listed On removed -->
            <div class="meta-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="property-card">
        ...
        <div class="property-details">
          <h3 data-translate="propertyRosehill">Rosehill</h3>
          <p class="property-type" data-translate="propertyTypeApartment">Apartment</p>
          ...
          <div class="property-meta">
            ...
            <div class="meta-item">
              ...
              <span data-translate="property.area">Area:</span> Dubai Hills Estate, Dubai
            </div>
            <!-- Listed On removed -->
            <div class="meta-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <span data-translate="property.handoverDate">Handover Date:</span> 06-2029
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="property-card">
        ...
        <div class="property-details">
          <h3 data-translate="propertyGolf">Golf Hillside</h3>
          <p class="property-type" data-translate="propertyTypeApartment">Apartment</p>
          ...
          <div class="property-meta">
            ...
            <div class="meta-item">
              ...
              <span data-translate="property.handoverDate">Handover Date:</span> 12-2028
            </div>
          </div>
        </div>
      </div>
  ...
  statsSection.innerHTML = `
    ...
    <div class="stats-header">
      <div class="stats-text">
        <h2 data-translate="missionTitle">Our mission is to redefine real<br>estate in the customer's favor.</h2>
        <p data-translate="missionSubtitle">Lorem ipsum dolor sit amet</p>
      </div>
      <button class="linear-button" id="learn-more-button">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="linear-button-icon">
          <path d="M5 12h14"/>
    ...
    <div class="stats-grid">
      <div class="stat-card">
        ...
        <div class="stat-value" data-translate="specialistConnect">Connect with a Specialist</div>
        <div class="stat-title" data-translate="expertAssistance">Expert Real Estate Assistance</div>
        <p data-translate="expertAssistanceDesc">Access our dedicated team of over 400+ expert agents ready to assist you. Our team of experienced real estate specialists is available to provide personalized assistance for all your property needs, from inquiries to closing deals.</p>
      </div>
      <div class="stat-card">
        <div class="stat-icon"><img src="/icons/property-icon.svg" alt="Property icon" /></div>
        <div class="stat-value" data-translate="listProperty">List Your Property</div>
        <div class="stat-title" data-translate="marketingSolutions">Professional Marketing Solutions</div>
        <p data-translate="marketingSolutionsDesc">Achieve optimal value by listing your property with our expert marketing strategies. Maximize your property's exposure with our comprehensive marketing approach, including professional photography, virtual tours, and targeted advertising campaigns.</p>
      </div>
      <div class="stat-card">
        <div class="stat-icon"><img src="/icons/report-icon.svg" alt="Report icon" /></div>
        <div class="stat-value" data-translate="downloadReport">Download Report</div>
        <div class="stat-title" data-translate="marketInsights">Market Insights for Informed Decisions</div>
        <p data-translate="marketInsightsDesc">Download the latest Comprehensive Dubai Real Estate Market Report Q1 2025. Gain valuable insights into market trends, property values, and investment opportunities with our detailed quarterly report covering the entire Dubai real estate landscape.</p>
      </div>
      <div class="stat-card">
        <div class="stat-icon"><img src="/icons/explore-icon.svg" alt="Explore icon" /></div>
        <div class="stat-value" data-translate="exploreProjects">Explore Dubai Projects</div>
        <div class="stat-title" data-translate="discoverDream">Discover Your Dream Property</div>
        <p data-translate="discoverDreamDesc">Browse and find your ideal property from our extensive portfolio of Dubai projects. Discover a wide range of residential and commercial properties across Dubai's most sought-after locations, with detailed information and specifications for each project.</p>
      </div>
    </div>
  `;
  ...
  newsSection.innerHTML = `
    <div class="section-header">
      <div class="news-header-text">
        <h2 data-translate="latestNews">Latest News</h2>
        <p data-translate="newsSubtitle">Stay updated with the latest trends and insights in the real estate market</p>
      </div>
      <a href="/all-news.html" class="linear-button" id="view-all-news-button">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="linear-button-icon">
            <path d="M5 12h14"/>
            <path d="m12 5 7 7-7 7"/>
          </svg>
          <span data-translate="viewAllNews">View All News</span>
        </a>
    </div>
    ...
    <div class="news-grid">
      <div class="news-card">
        <div class="news-image-container">
          <img src="/images_new/news/news-1/微信图片_2025-10-11_152316_267.jpg" alt="Lyvia By Palace Project" />
          <div class="news-date">October 13, 2025</div>
        </div>
        <div class="news-content">
          <h3 data-translate="newsTitle1">Lyvia By Palace Grand Launch on October 13, 2025</h3>
          <p data-translate="newsDesc1">Lyvia By Palace will launch at 5:00 PM on October 13, 2025, with expected delivery in 2029. Located at a prime location with imminent completion of Cloud Tower, upcoming metro line opening, prestigious schools, shopping malls and commercial buildings. Whether for investment or personal residence, Lyvia By Palace is an excellent choice.</p>
      ...
      <div class="news-card">
        <div class="news-image-container">
          <img src="/images_new/news/news-2/微信图片_2025-10-11_155933_842.png" alt="SOLAYA: New Luxury Residence at Dubai's La Mer Beach" />
          <div class="news-date">January 8, 2025</div>
        </div>
        <div class="news-content">
          <h3 data-translate="newsTitle2">SOLAYA: New Luxury Residence at Dubai's La Mer Beach, Combining Frontline Sea View and Urban Vibrancy</h3>
          <p data-translate="newsDesc2">In Dubai's high-end real estate market, frontline sea view luxury properties with prime locations have always been rare. Now, La Mer Beach on the Jumeirah Gold Coast welcomes a new luxury residential project - SOLAYA.</p>
          <a href="#" class="news-link" data-translate="readMore">Read more</a>
        </div>
      </div>
      ...
      <div class="news-card">
        <div class="news-image-container">
          <img src="/images_new/news/news-3/微信图片_2025-10-11_162014_033.png" alt="UAE Real Estate Market Report" />
          <div class="news-date">January 2, 2025</div>
        </div>
        <div class="news-content">
          <h3 data-translate="newsTitle3">Report Analysis: UAE Real Estate Becomes Core Driver of Economic Growth</h3>
          <p data-translate="newsDesc3">Amid global economic challenges, the UAE continues to strengthen its position as an "investment safe haven" in the Middle East with its unique geographical advantages and stable investment environment. The latest report indicates that the real estate industry has become a key engine driving the UAE's economic growth.</p>
          <a href="#" class="news-link" data-translate="readMore">Read more</a>
        </div>
      </div>
    </div>
  ...
  contactSection.innerHTML = `
    <div class="contact-content">
      ...
      <form class="contact-form">
        <!-- 输入框行 -->
        <div class="form-row">
          <input type="text" placeholder="Your Name" data-translate-placeholder="formNamePlaceholder" required />
        ...
        <div class="form-submit">
          <button type="submit" data-translate="formSubmitButton">Send Message</button>
        </div>
        
        <!-- 成功消息 -->
        <div class="success-message">
          <p data-translate="formSuccessMessage">Message sent successfully!</p>
        </div>
      </form>
  ...
  footer.innerHTML = `
    <div class="footer-container">
      ...
      <div class="footer-brand">
        ...
        <p class="footer-tagline" data-translate="footerTagline">Premium real estate platform in Dubai and UAE</p>
      </div>
      ...
      <div class="footer-links-container">
        <div class="footer-column">
          ...
          <ul class="footer-links">
            <li><a href="#" data-translate="footerHome">Home</a></li>
            <li><a href="#properties" data-translate="footerProperties">Properties</a></li>
            <li><a href="#about" data-translate="footerAboutUs">About Us</a></li>
            <li><a href="#contact" data-translate="footerContact">Contact</a></li>
          </ul>
        </div>
        ...
        <div class="footer-column">
          ...
          <ul class="footer-links">
            <li><a href="#" data-translate="footerBuyProperty">Buy Property</a></li>
            <li><a href="#" data-translate="footerSellProperty">Sell Property</a></li>
            <li><a href="#" data-translate="footerRentProperty">Rent Property</a></li>
            <li><a href="#" data-translate="footerPropertyManagement">Property Management</a></li>
          </ul>
        </div>
        
        <div class="footer-column">
          <h4 data-translate="footerContactUs">Contact Us</h4>
          <ul class="footer-links">
            <li data-translate="footerEmail">Info@hawsonhouse.com</li>
            <li data-translate="footerPhone">+971 506956105</li>
            <li data-translate="footerAddress">Dubai Marina, Dubai</li>
          </ul>
        </div>
      </div>
    ...
    <div class="company-intro-content">
      ...
      <div class="company-intro-carousel-container">
        <div class="company-intro-carousel">
          ...
          <div class="carousel-slide" style="opacity: 0; z-index: 1;">
            <img src="/images_new/lunbotu/L1.webp" alt="Property showcase 2">
          </div>
          <div class="carousel-slide" style="opacity: 0; z-index: 1;">
            <img src="/images_new/lunbotu/L3.png" alt="Property showcase 3">
          </div>
        </div>
        <div class="carousel-indicators">
          <button class="carousel-indicator active"></button>
      ...
      <div class="company-intro-text">
        <h2 data-translate="companyIntroTitle">The new way to find your<br>development opportunities</h2>
        <p data-translate="companyIntroDesc">Discover your next development project with more than 10+opportunities and professional services listed.</p>
        <div class="company-stats">
          <div class="company-stat">
            <div class="stat-number">400+</div>
            <div class="stat-label" data-translate="companyStatAgents">Agents</div>
          </div>
          <div class="company-stat">
            <div class="stat-number">4000+</div>
            <div class="stat-label" data-translate="companyStatListings">Listings</div>
          </div>
          <div class="company-stat">
            <div class="stat-number">80+</div>
            <div class="stat-label" data-translate="companyStatCountries">Countries</div>
          </div>
        </div>
      </div>
    </div>
  ...
  if ((window.location.pathname === '/' || window.location.pathname === '/index.html') && !isStandalonePage) {
    ...
    newsLinks.forEach(link => {
      link.addEventListener('click', function(e) {
        ...
        const title = newsCard.querySelector('.news-content h3').textContent;
        ...
        if (title.includes('Lyvia By Palace')) {
          newsId = 'lyvia';
          modalImage.src = '/images_new/news/news-1/微信图片_2025-10-11_152316_267.jpg';
        } else if (title.includes('SOLAYA')) {
          newsId = 'solaya';
          modalImage.src = '/images_new/news/news-2/微信图片_2025-10-11_155933_842.png';
        } else if (title.includes('Report Analysis') || title.includes('报告分析')) {
          newsId = 'report';
          modalImage.src = '/images_new/news/news-3/微信图片_2025-10-11_162014_033.png';
        }
        
        // 填充弹窗内容
        modalImage.src = modalImage.src; // 确保使用特定图片
        ...
        if (newsId === 'lyvia') {
          ...
          modalContent.innerHTML = t.reportModalContent || '';
        } else {
          modalContent.innerHTML = t.defaultModalContent || 'Stay tuned for more updates and detailed information.';
        }
  ...
  function initCompanyIntroCarousel() {
    ...
    // 显示指定索引的幻灯片 - 使用requestAnimationFrame优化
    ...
    function startCarousel() {
      // 优化轮播性能，添加requestAnimationFrame
      ...
      contactForm.addEventListener('submit', async (e) => {
        ...
        const translations = {
          ...
          ar: {
            fillAllFields: 'يرجى ملء جميع الحقول',
            validEmail: 'يرجى إدخال عنوان بريد إلكتروني صالح',
            successMessage: 'تم إرسال رسالتك بنجاح! سنتصل بك قريبًا.',
